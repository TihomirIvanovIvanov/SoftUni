...
public class InspectCommand : Command
{
    ...
    public override string Execute()
    {
        ...
        var allEntities = this.harvesterController
            .Entities.ToArray()
            .Concat(this.providerController.Entities.ToArray());

        var neededEntity = allEntities
        ...
        var entityToString = $"{neededEntity.GetType().Name}" + Environment.NewLine +
                             $"Durability: {neededEntity.Durability}";

        //TODO return entityToString;
