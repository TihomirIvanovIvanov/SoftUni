...
namespace FootballTeamGenerator
{
    public class StartUp
    {
            ...
            while (input != "END")
            {
                ...
                try
                {
                    switch (cmd)
                    {
                        ...
                        case "Add":
                            AddPlayerToTeam(tokens[1], tokens[2],
                                int.Parse(tokens[3]), int.Parse(tokens[4]), int.Parse(tokens[5]), int.Parse(tokens[6]), int.Parse(tokens[7]));
                            break;
        ...
        private static void AddPlayerToTeam(string teamName, string playerName,
