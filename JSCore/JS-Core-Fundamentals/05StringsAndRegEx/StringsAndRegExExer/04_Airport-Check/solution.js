function solve() {
    ...
    switch (info) {
        case "name":
            resultEl.textContent = `Mr/Ms, ${name}, have a nice flight!`;
            break;
        case "flight":
            resultEl.textContent = `Your flight number ${flight} is from ${fromAirport} to ${toAirport}.`;
            break;
        case "company":
            resultEl.textContent = `Have a nice flight with ${company}.`;
            break;
        case "all":
            resultEl.textContent = `Mr/Ms, ${name}, your flight number ${flight} is from ${fromAirport} to ${toAirport}. Have a nice flight with ${company}.`;
            break;
    }
}