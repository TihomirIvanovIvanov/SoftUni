    ...
    public class StartUp
    {
        ...
        public static void Main()
        {
            ...
            while (command != "Output")
            {
                ...
                var containsFreeSpace = department.Rooms
                    .Sum(room => room.Patients.Count) < 60;
            ...
            while (command != "End")
            {
                ...
                if (args.Length == 1)
                {
                    ...
                    var roomWithPatients = department.Rooms
                        .Where(room => room.Patients.Count > 0);
        ...
        {
            var doctor = doctors
                .FirstOrDefault(doctor => doctor.FirstName == firstName && doctor.LastName == lastName);
        ...
        private static Department GetDepartment(string departmentName)
        {
            var department = departments
                .FirstOrDefault(department => department.Name == departmentName);
