...
namespace SIS.MvcFramework.Attributes.Validation
{
    public class RangeSisAttribute : ValidationSisAttribute
    {
        ...
        public RangeSisAttribute(int minValue, int maxValue, string errorMessage = "Error Message")
            : base(errorMessage)
        {
        ...
        public RangeSisAttribute(double minValue, double maxValue, string errorMessage = "Error Message")
           : base(errorMessage)
        {
            this.minValue = minValue;
            this.maxValue = maxValue;
        ...
        public RangeSisAttribute(Type type, string minValue, string maxValue, string errorMessage = "Error Message")
           : base(errorMessage)
        {
            this.minValue = minValue;
            this.maxValue = maxValue;
        ...
        public override bool IsValid(object value)
        {
            ...
            {
                return (decimal)value >= (decimal)this.minValue && (decimal)value <= (decimal)this.maxValue;
            }
            return false;
        }
    }
